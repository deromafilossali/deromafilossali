        ...
        if len(Byts.json()['records']) > 0 :
            ...
            for byt in Byts.json()['records']:      
                ...
                if ( BS_Count.json()['record_count'] > 0 ) and MainRow == 3:
                    ...
                    for bs in BSs.json()['records']:
                        ...
                        Sheet.Cells(MainRow,MainColumn + 4).Value = 'Payment'
                        Sheet.Cells(MainRow,MainColumn + 5).Value = 'Warranty'
                        Sheet.Cells(MainRow,MainColumn + 6).Value = 'Cost'
                        Sheet.Cells(MainRow,MainColumn + 7).Value = 'Sales'
                ...
                Sheet.Cells(MainRow,2).Value = round(dates.days/7)
                #Sheet.Cells(MainRow,2).NumberFormat = "mm/dd/yyyy"
                Sheet.Cells(MainRow,3).Value = byt['tag_c']
                Sheet.Cells(MainRow,4).Value = Product.json()['records'][0]['size_qli_c']
            ...
            if ( BS_Count.json()['record_count'] > 0 ):
                ...
                for bs in BSs.json()['records']:
                    ...
                    MainColumn += 5
                    Sheet.Cells( MainRow , MainColumn ).Formula = 1 - Sheet.Cells( MainRow , MainColumn - 5 ).Value / Sheet.Cells( MainRow , 8 ).Value
                    Sheet.Cells( MainRow , MainColumn ).Style = 'Percent'
                    MainColumn += 1
                    Sheet.Cells( MainRow , MainColumn ).Formula = 1 - Sheet.Cells( MainRow , MainColumn - 6 ).Value / Sheet.Cells( MainRow , 10 ).Value
                    Sheet.Cells( MainRow , MainColumn ).Style = 'Percent'
                    MainColumn += 2
...
def index(column,start):
    ...
    if start == True :
        ...
        if column < 20:
            ...
            return chr(x + orden - 7) + chr(x + (column - diff))
