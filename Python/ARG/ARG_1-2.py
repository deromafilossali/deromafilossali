    ...
    if len(GPS) > 5 :
        if len(Byts.json()['records']) > 0 :
            ...
            for byt in Byts.json()['records']:      
                ...
                Sheet.Cells(MainRow,7).Value = int(byt['total_c']) / int(byt['quantity_c']) #byt['cost_usd_c']
                Sheet.Cells(MainRow,7).Style = 'Currency'
                Sheet.Cells(MainRow,8).Value = byt['total_c'] #byt['extended_price_c']
            ...
            MainRow += 2
            Sheet.Cells(MainRow,4).Value = 'Leading CFF'
            Sheet.Cells(MainRow,4).Interior.Color = rgbToInt((6,121,200))
            Sheet.Cells(MainRow,4).Font.Color = rgbToInt((255,255,255))
            Sheet.Cells(MainRow,4).Font.Bold  = True
            Sheet.Cells(MainRow,5).Value = Quote.json()['leading_cff_c']
            MainRow += 1
            Sheet.Cells(MainRow,4).Value = 'CFF for Bareshaft'
            Sheet.Cells(MainRow,4).Interior.Color = rgbToInt((6,121,200))
            Sheet.Cells(MainRow,4).Font.Color = rgbToInt((255,255,255))
            Sheet.Cells(MainRow,4).Font.Bold  = True
            Sheet.Cells(MainRow,5).Value = Quote.json()['cff_for_bareshaft_c']
            MainRow += 1
            Sheet.Cells(MainRow,4).Value = 'Packing CFF'
            Sheet.Cells(MainRow,4).Interior.Color = rgbToInt((6,121,200))
            Sheet.Cells(MainRow,4).Font.Color = rgbToInt((255,255,255))
            Sheet.Cells(MainRow,4).Font.Bold  = True
            Sheet.Cells(MainRow,5).Value = Quote.json()['packaging_cff_c']
